...
const fundNavItems = [
  {
    ...
    href: 'mandates',
    icon: Target,
    description: 'Investment mandates and strategies',
  },
  {
    label: 'Constitution',
    href: 'constitution',
  ...
  },
  {
    ...
    href: 'reasoning',
    icon: Brain,
    description: 'AI reasoning runs and evaluations',
  },
  {
    label: 'Decisions',
    href: 'decisions',
  ...
  },
  {
    ...
    href: 'positions',
    icon: PieChart,
    description: 'Portfolio exposures and monitoring',
  },
  {
    label: 'Reports',
    href: 'reports',
  ...
  },
  {
    ...
    href: 'precedents',
    icon: Scale,
    description: 'Case law and drift tracking',
  },
  {
    label: 'Access',
    href: 'access',
